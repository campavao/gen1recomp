...
thirty SAFARI BALLs, six Poké Balls, a Potion and two minutes — no starter,
so the team you leave with is the team you caught. When the PA calls time
you pick the town you drop into. From there you see the other trainers
...
the TOWN MAP draws that exact grid, so the start menu's MAP row you already
reach for to work out where you are also shows you where it is safe to be: taken squares
